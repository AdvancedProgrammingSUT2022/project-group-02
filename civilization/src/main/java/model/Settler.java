...
public class Settler extends Civilian{
    ...
    public Settler(String name, Tile tile, int HP, int price, int level, int MP, int combatStrength, int rangeCombatStrength, ArrayList<Tile> possibleTilesForCities) {
