...
public class SettlerController extends UnitController{
    ...
    public static void addBasicUnits(City city) {
        ...
        units.add(new Civilian("Tank", null, 100, 5, 1, 1, 2, 4, 0, city.getOwner(), 4, 0));
        units.add(new Civilian("Knight", null, 100, 5, 1, 1, 2, 4, 0, city.getOwner(), 4, 0));
        units.add(new Civilian("Pikeman", null, 100, 5, 1, 1, 2, 4, 0, city.getOwner(), 4, 0));
        city.setPossibleUnits(units);
    }

    public static void addBasicBuildings(City city) {
        ...
        buildings.add(new Building("Barracks", 2, 120, 2, 0, 0, 0, 0, null));
        buildings.add(new Building("Walls", 2, 120, 2, 0, 0, 0, 0, null));
